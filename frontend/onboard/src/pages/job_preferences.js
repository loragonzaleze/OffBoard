...
function JobPreferences() {
	...
	return (
		<div className="centered-container">
			...
			<text className="interests-subtitle-text">Work on your terms</text>
			<text className="job-preferences-title-text">
				Preferred Work Model(s)
			</text>
			<div className="job-preferences-work-location-container">
				<button
					className={
						onsite
							? 'job-preferences-button-container-clicked'
							: 'job-preferences-button-container'
					}
			...
			>
				...
				<Dropdown.Item eventKey="$70,000-$100,000">
					$70,000-$100,000
				</Dropdown.Item>
				<Dropdown.Item eventKey="$100,000-$140,000">
					$100,000-$140,000
				</Dropdown.Item>
				<Dropdown.Item eventKey="$140,000-$180,000">
					$140,000-$180,000
				</Dropdown.Item>
				<Dropdown.Item eventKey="$180,000-$230,000">
					$180,000-$230,000
				</Dropdown.Item>
				<Dropdown.Item eventKey="$230,000-$280,000">
					$230,000-$280,000
				</Dropdown.Item>
