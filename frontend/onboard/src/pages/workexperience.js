      ...
      <div className = "we-centered-container" style = {{}}>
        ...
        <label>
          <div className = "row-container">
            ...
            <p className = "we-label" 
            style = {{color: 'red', marginLeft: '2px'}}>*</p>
          </div>
          <input className = "we-input-box"onChange = {e => setPrevCompany(e.target.value)}/>
        </label>


        <div className= "we-title-box">
            <div className = "we-title-text">
                What was your team or department?
            </div>
        </div>
        <label>
          <div className = "row-container">
          ...
          <input className = "we-input-box" onChange = {e => setTeam(e.target.value)}/>
        </label>
        ...
        <label>
          ...
          <input className = "we-input-box" onChange = {e => setJobTitle(e.target.value)}/>
        </label>
