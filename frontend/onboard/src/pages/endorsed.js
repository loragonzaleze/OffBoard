...
function Endorsed() {
	...
	return (
		<div className="centered-container">
			<div className="endorsed-logo" onClick={goToHome}>
				Layup
			</div>
			<div className="endorsed-title-text">
				Welcome {name}, {company} has endorsed you!
			</div>
			<div className="endorsed-subtitle-text">Tell us more about yourself!</div>
			<div className="endorsed-info-container">
				...
				<div className="row-container">
					<label>
						<div className="row-container">
							...
							<p
								className="endorsed-email-label"
				...
				<text className="endorsed-email-text">
					...
					<text style={{ fontWeight: 600 }}> not your corporate</text>. We will
					continue to contact you after your time at your current company comes
					to an end.
				</text>
				{/* PHONE NUM */}
				<label>
				...
				<button className="endorsed-submit-box" onClick={goToChooseInterests}>
					Next
				</button>
			</div>
		</div>
