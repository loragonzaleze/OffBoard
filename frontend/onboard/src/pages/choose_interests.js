...
function ChooseInterests() {
	...
	return (
		<div className="centered-container">
			<div className="interests-logo" onClick={goToHome}>
				Layup
			</div>
			<text className="interests-title-text">Your Specialty or Interest</text>
			<text className="interests-subtitle-text">What's your strong suit?</text>
			<div className="interests-container">
				<div className="row-container">
					<button
						className={
							interests[0] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(0)}
					>
					...
					<button
						className={
							interests[1] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(1)}
					>
				...
				<div className="row-container">
					<button
						className={
							interests[2] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(2)}
					>
					...
					<button
						className={
							interests[3] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(3)}
					>
				...
				<div className="row-container">
					<button
						className={
							interests[4] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(4)}
					>
					...
					<button
						className={
							interests[5] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(5)}
					>
				...
				<div className="row-container">
					<button
						className={
							interests[6] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(6)}
					>
					...
					<button
						className={
							interests[7] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(7)}
					>
				...
				<div className="row-container">
					<button
						className={
							interests[8] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(8)}
					>
					...
					<button
						className={
							interests[9] ? 'interests-button-clicked' : 'interests-button'
						}
						onClick={() => updateMap(9)}
					>
				...
				<div className="row-container">
					<button
						className={
							interests[10] ? 'interests-button-clicked' : 'interests-button'
						}
					...
					<button
						className={
							interests[11] ? 'interests-button-clicked' : 'interests-button'
						}
				...
				<div className="row-container">
					<button
						className={
							interests[12] ? 'interests-button-clicked' : 'interests-button'
						}
					...
					<button
						className={
							interests[13] ? 'interests-button-clicked' : 'interests-button'
						}
				...
				{selectedJobCategory ? null : (
					<p className="interests-error-text">Please select a job category</p>
				)}
