    ...
    return (
      <div>
        ...
        <div className = "about-centered-container">
          <text className = "about-title-text"> Every ending is really just a new beginning. </text>
          <div className = "about-text-container">
            <text className ="about-normal-text"> 
              HRnext aims to create new relationsips. Whether you are hiring
              or looking for a new gig, use Portal to grow your network and
              start a new chapter.
            </text>
          </div>
          <div className="about-row-container-2">
            <div className="about-row-container-2-box">
              <BsArrowsAngleExpand className="about-icon-style" style={{fontSize: 50,}}/>
            ...
            <div className="about-row-container-2-box">
              <BsLightningCharge className="about-icon-style" style={{fontSize:50,}}/>
              <text className="about-normal-text-3">
                Back on the grind
              </text>
            </div>
