...
function Login() {
	...
	return (
		...
		>
			...
			<div className="login-title-text">Log in with your email</div>
			...
			<label>
				...
				<input
					className={validEmail ? 'login-input-box' : 'wrong-email-input-box'}
					onChange={(e) => setEmail(e.target.value)}
					value={email}
					onClick={clearEmailAndPassword}
				/>
				{validEmail ? null : (
			...
			<label>
				<div className="row-container">
					<p className="login-email-label" style={{ paddingTop: 10 }}>
						Password
					</p>
					<p
						className="login-email-label"
						style={{ color: 'red', marginleft: '2px', paddingTop: 10 }}
					>
						*
					</p>
				</div>
				<input
					className={validPass ? 'login-input-box' : 'wrong-email-input-box'}
			...
			<div className="login-endorsement-box">
				...
				<div className="login-endorsement-button">
					Ask your company to endorse you
				</div>
				{/*TODO add a link here for endorsement*/}
			</div>
			<div
